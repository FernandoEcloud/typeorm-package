            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 15:
                        ...
                        if (args.name) {
<<<<<<< HEAD
                            console.log(chalk_1.default.green("Project created inside ".concat(chalk_1.default.blue(basePath), " directory.")));
=======
...
<<<<<<< HEAD
        return "import {Entity, ".concat(database === "mongodb" ? "ObjectIdColumn, ObjectID" : "PrimaryGeneratedColumn", ", Column} from \"typeorm\";\n\n@Entity()\nexport class User {\n\n    ").concat(database === "mongodb" ? "@ObjectIdColumn()" : "@PrimaryGeneratedColumn()", "\n    id: ").concat(database === "mongodb" ? "ObjectID" : "number", ";\n\n    @Column()\n    firstName: string;\n\n    @Column()\n    lastName: string;\n\n    @Column()\n    age: number;\n\n}\n");
=======
...
<<<<<<< HEAD
        return "import {UserController} from \"./controller/UserController".concat(isEsm ? ".js" : "", "\";\n\nexport const Routes = [{\n    method: \"get\",\n    route: \"/users\",\n    controller: UserController,\n    action: \"all\"\n}, {\n    method: \"get\",\n    route: \"/users/:id\",\n    controller: UserController,\n    action: \"one\"\n}, {\n    method: \"post\",\n    route: \"/users\",\n    controller: UserController,\n    action: \"save\"\n}, {\n    method: \"delete\",\n    route: \"/users/:id\",\n    controller: UserController,\n    action: \"remove\"\n}];");
=======
