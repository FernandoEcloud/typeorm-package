...
var QueryExpressionMap = /** @class */ (function () {
    ...
    QueryExpressionMap.prototype.findAliasByName = function (aliasName) {
        ...
        if (!alias)
<<<<<<< HEAD
            throw new error_1.TypeORMError("\"".concat(aliasName, "\" alias was not found. Maybe you forgot to join it?"));
=======
...
>>>>>>> a3495c7 (INIT)
    ...
    QueryExpressionMap.prototype.findColumnByAliasExpression = function (aliasExpression) {
        var _a = (0, tslib_1.__read)(aliasExpression.split("."), 2), aliasName = _a[0], propertyPath = _a[1];
    ...
    Object.defineProperty(QueryExpressionMap.prototype, "relationMetadata", {
        ...
        get: function () {
            ...
            if (!relationMetadata)
<<<<<<< HEAD
                throw new error_1.TypeORMError("Relation ".concat(this.relationPropertyPath, " was not found in entity ").concat(this.mainAlias.name)); // todo: better message
=======
...
>>>>>>> a3495c7 (INIT)
    ...
    QueryExpressionMap.prototype.clone = function () {
        ...
        map.wheres = this.wheres.map(function (where) { return ((0, tslib_1.__assign)({}, where)); });
        map.havings = this.havings.map(function (having) { return ((0, tslib_1.__assign)({}, having)); });
