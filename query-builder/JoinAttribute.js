        ...
        get: function () {
            ...
            if (!this.isSelectedEvaluated) {
                var getValue = function () {
                    ...
                    try {
                        for (var _b = (0, tslib_1.__values)(_this.queryExpressionMap.selects), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var select = _c.value;
...
<<<<<<< HEAD
                    throw new error_1.TypeORMError("Relation with property path ".concat(_this.relationPropertyPath, " in entity was not found."));
=======
