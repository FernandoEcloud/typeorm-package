...
var NotBrackets_1 = require("./NotBrackets");
...
var QueryBuilder = /** @class */ (function () {
    ...
    QueryBuilder.prototype.update = function (entityOrTableNameUpdateSet, maybeUpdateSet) {
        ...
        entityOrTableNameUpdateSet = entityOrTableNameUpdateSet instanceof EntitySchema_1.EntitySchema ? entityOrTableNameUpdateSet.options.name : entityOrTableNameUpdateSet;
    ...
    QueryBuilder.prototype.setParameters = function (parameters) {
        var e_1, _a;
        try {
            for (var _b = (0, tslib_1.__values)(Object.entries(parameters)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    QueryBuilder.prototype.printSql = function () {
        var _a = (0, tslib_1.__read)(this.getQueryAndParameters(), 2), query = _a[0], parameters = _a[1];
    ...
    QueryBuilder.prototype.replacePropertyNames = function (statement) {
        ...
        var _loop_1 = function (alias) {
            ...
            try {
                ...
                for (var _k = (e_3 = void 0, (0, tslib_1.__values)(alias.metadata.relations)), _l = _k.next(); !_l.done; _l = _k.next()) {
            ...
            try {
                for (var _m = (e_4 = void 0, (0, tslib_1.__values)(alias.metadata.relations)), _o = _m.next(); !_o.done; _o = _m.next()) {
            ...
            try {
                for (var _r = (e_6 = void 0, (0, tslib_1.__values)(alias.metadata.columns)), _s = _r.next(); !_s.done; _s = _r.next()) {
                    var column = _s.value;
            ...
            try {
                for (var _t = (e_7 = void 0, (0, tslib_1.__values)(alias.metadata.columns)), _u = _t.next(); !_u.done; _u = _t.next()) {
                    var column = _u.value;
            ...
            try {
                for (var _v = (e_8 = void 0, (0, tslib_1.__values)(alias.metadata.columns)), _w = _v.next(); !_w.done; _w = _v.next()) {
                    var column = _w.value;
        ...
        var this_1 = this;
        try {
            for (var _b = (0, tslib_1.__values)(this.expressionMap.aliases), _c = _b.next(); !_c.done; _c = _b.next()) {
                var alias = _c.value;
                _loop_1(alias);
            }
        }
    ...
    QueryBuilder.prototype.createReturningExpression = function () {
        ...
        if (typeof this.expressionMap.returning !== "string" &&
            ...
            columns.push.apply(columns, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this.expressionMap.extraReturningColumns.filter(function (column) {
        ...
        if (Array.isArray(this.expressionMap.returning)) {
            this.expressionMap.returning.forEach(function (columnName) {
                if (_this.expressionMap.mainAlias.hasMetadata) {
                    columns.push.apply(columns, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(_this.expressionMap.mainAlias.metadata.findColumnsWithPropertyPath(columnName)), false));
                }
            });
        }
        return columns;
        ...
        switch (condition.operator) {
            ...
            case "ilike":
                if (driver instanceof PostgresDriver_1.PostgresDriver || driver instanceof CockroachDriver_1.CockroachDriver) {
                    return "".concat(condition.parameters[0], " ILIKE ").concat(condition.parameters[1]);
                }
                return "UPPER(".concat(condition.parameters[0], ") LIKE UPPER(").concat(condition.parameters[1], ")");
            case "like":
            ...
            case "isNull":
                return "".concat(condition.parameters[0], " IS NULL");
            case "not":
                return "NOT(".concat(this.createWhereConditionExpression(condition.condition), ")");
            case "brackets":
    ...
    QueryBuilder.prototype.getWhereInIdsCondition = function (ids) {
        ...
        return new Brackets_1.Brackets(function (qb) {
            ...
            try {
                for (var normalized_1 = (0, tslib_1.__values)(normalized), normalized_1_1 = normalized_1.next(); !normalized_1_1.done; normalized_1_1 = normalized_1.next()) {
    ...
    QueryBuilder.prototype.createPropertyPath = function (metadata, entity, prefix) {
        ...
        var this_3 = this;
        try {
            for (var _b = (0, tslib_1.__values)(Object.keys(entity)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
                _loop_4(key);
            }
        }
        ...
        return (0, tslib_1.__generator)(this, function (_h) {
            switch (_h.label) {
                ...
                case 1:
                    ...
                    propertyPaths_1 = (0, tslib_1.__values)(propertyPaths), propertyPaths_1_1 = propertyPaths_1.next();
                    _h.label = 2;
                case 2:
                    if (!!propertyPaths_1_1.done) return [3 /*break*/, 11];
                    propertyPath = propertyPaths_1_1.value;
                    _a = (0, tslib_1.__read)(this.findColumnsForPropertyPath(propertyPath), 3), alias = _a[0], aliasPropertyPath = _a[1], columns = _a[2];
                    _h.label = 3;
                case 3:
                    _h.trys.push([3, 8, 9, 10]);
                    columns_1 = (e_11 = void 0, (0, tslib_1.__values)(columns)), columns_1_1 = columns_1.next();
                    _h.label = 4;
                case 4:
                    ...
                    try {
                        for (aliasPropertyPath_1 = (e_14 = void 0, (0, tslib_1.__values)(aliasPropertyPath)), aliasPropertyPath_1_1 = aliasPropertyPath_1.next(); !aliasPropertyPath_1_1.done; aliasPropertyPath_1_1 = aliasPropertyPath_1.next()) {
                ...
                case 15:
                    ...
                    _b = (0, tslib_1.__values)(Object.keys(where)), _c = _b.next();
                    _h.label = 16;
                case 16:
        ...
        if (parameterValue instanceof FindOperator_1.FindOperator) {
            ...
            if (parameterValue.useParameter) {
                if (parameterValue.objectLiteralParameters) {
                    ...
                    try {
                        for (var _b = (0, tslib_1.__values)(parameterValue.value), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var v = _c.value;
            ...
            if (parameterValue.type === "raw") {
                ...
                if (parameterValue.child) {
                    ...
                    return {
                        operator: "notEqual",
                        parameters: (0, tslib_1.__spreadArray)([
                            aliasPath
                        ], (0, tslib_1.__read)(parameters), false)
                    };
                }
            }
            else {
    ...
    QueryBuilder.prototype.getWhereCondition = function (where) {
        ...
        if (where instanceof Brackets_1.Brackets) {
            ...
            return {
                operator: where instanceof NotBrackets_1.NotBrackets ? "not" : "brackets",
        ...
        var clauses = [];
        try {
            for (var wheres_1 = (0, tslib_1.__values)(wheres), wheres_1_1 = wheres_1.next(); !wheres_1_1.done; wheres_1_1 = wheres_1.next()) {
                var where_1 = wheres_1_1.value;
                var conditions = [];
                try {
                    // Filter the conditions and set up the parameter values
                    for (var _c = (e_17 = void 0, (0, tslib_1.__values)(this.getPredicates(where_1))), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var _e = (0, tslib_1.__read)(_d.value, 2), aliasPath = _e[0], parameterValue = _e[1];
                        conditions.push({
                            type: "and",
