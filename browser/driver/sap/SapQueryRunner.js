...
var SapQueryRunner = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, new Promise(function (ok, fail) {
                                statement.exec(parameters, function (err, raw) { return err ? fail(new QueryFailedError(query, parameters, err)) : ok(raw); });
                            })];
                    case 4:
                        raw = _a.sent();
                        ...
                        return [4 /*yield*/, new Promise(function (ok, fail) {
                                databaseConnection_1.exec(lastIdQuery_1, function (err, raw) { return err ? fail(new QueryFailedError(lastIdQuery_1, [], err)) : ok(raw); });
                            })];
                    case 5:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        // rename table
                        upQueries.push(new Query("RENAME TABLE ".concat(this.escapePath(oldTable), " TO ").concat(this.escapePath(newTableName))));
                        downQueries.push(new Query("RENAME TABLE ".concat(this.escapePath(newTable), " TO ").concat(this.escapePath(oldTableName))));
                    ...
                    case 4:
                        ...
                        if (newTable.primaryColumns.length > 0) {
                            ...
                            // drop old PK
                            upQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(newTable), " DROP CONSTRAINT \"").concat(oldPkName, "\"")));
                            downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(newTable), " ADD CONSTRAINT \"").concat(oldPkName, "\" PRIMARY KEY (").concat(columnNamesString, ")")));
                            // create new PK
                            upQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(newTable), " ADD CONSTRAINT \"").concat(newPkName, "\" PRIMARY KEY (").concat(columnNamesString, ")")));
                            downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(newTable), " DROP CONSTRAINT \"").concat(newPkName, "\"")));
                        }
                ...
                switch (_b.label) {
                    ...
                    case 6:
                        if (newColumn.name !== oldColumn.name) {
                            // rename column
                            upQueries.push(new Query("RENAME COLUMN ".concat(this.escapePath(table), ".\"").concat(oldColumn.name, "\" TO \"").concat(newColumn.name, "\"")));
                            downQueries.push(new Query("RENAME COLUMN ".concat(this.escapePath(table), ".\"").concat(newColumn.name, "\" TO \"").concat(oldColumn.name, "\"")));
                            if (oldColumn.isPrimary === true) {
                                ...
                                columnNamesString = columnNames.map(function (columnName) { return "\"".concat(columnName, "\""); }).join(", ");
                                // drop old PK
                                upQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(clonedTable), " DROP CONSTRAINT \"").concat(oldPkName, "\"")));
                                downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(clonedTable), " ADD CONSTRAINT \"").concat(oldPkName, "\" PRIMARY KEY (").concat(columnNamesString, ")")));
                                newPkName = this.connection.namingStrategy.primaryKeyName(clonedTable, columnNames);
                                // create new PK
                                upQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(clonedTable), " ADD CONSTRAINT \"").concat(newPkName, "\" PRIMARY KEY (").concat(columnNamesString, ")")));
                                downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(clonedTable), " DROP CONSTRAINT \"").concat(newPkName, "\"")));
                            }
                            // rename index constraints
                        ...
                        if (this.isColumnChanged(oldColumn, newColumn)) {
                            upQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " ALTER (").concat(this.buildCreateColumnSql(newColumn), ")")));
                            downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " ALTER (").concat(this.buildCreateColumnSql(oldColumn), ")")));
                        }
                        ...
                        if (newColumn.default !== oldColumn.default) {
                            if (newColumn.default !== null && newColumn.default !== undefined) {
                                upQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " ALTER (\"").concat(newColumn.name, "\" ").concat(this.connection.driver.createFullType(newColumn), " DEFAULT ").concat(newColumn.default, ")")));
                                if (oldColumn.default !== null && oldColumn.default !== undefined) {
                                    downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " ALTER (\"").concat(oldColumn.name, "\" ").concat(this.connection.driver.createFullType(oldColumn), " DEFAULT ").concat(oldColumn.default, ")")));
                                }
                                else {
                                    downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " ALTER (\"").concat(oldColumn.name, "\" ").concat(this.connection.driver.createFullType(oldColumn), " DEFAULT NULL)")));
                                }
                            }
                            else if (oldColumn.default !== null && oldColumn.default !== undefined) {
                                upQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " ALTER (\"").concat(newColumn.name, "\" ").concat(this.connection.driver.createFullType(newColumn), " DEFAULT NULL)")));
                                downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " ALTER (\"").concat(oldColumn.name, "\" ").concat(this.connection.driver.createFullType(oldColumn), " DEFAULT ").concat(oldColumn.default, ")")));
                            }
                        }
                        return [4 /*yield*/, this.executeQueries(upQueries, downQueries)];
                    ...
                    case 7:
                        ...
                        if (columnIndex) {
                            ...
                            if (foundUnique) {
                                ...
                                downQueries.push(new Query("CREATE UNIQUE INDEX \"".concat(uniqueName_1, "\" ON ").concat(this.escapePath(table), " (\"").concat(column.name, "\")")));
                            }
                            ...
                            if (foundIndex) {
                                ...
                                downQueries.push(new Query("CREATE UNIQUE INDEX \"".concat(indexName_1, "\" ON ").concat(this.escapePath(table), " (\"").concat(column.name, "\")")));
                            }
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        query = "SELECT \"t\".* FROM ".concat(this.escapePath(this.getTypeormMetadataTableName()), " \"t\" WHERE \"t\".\"type\" = '").concat(MetadataTableType.VIEW, "' ").concat(viewsCondition ? "AND (".concat(viewsCondition, ")") : "");
                        return [4 /*yield*/, this.query(query)];
                    case 4:
                        dbViews = _a.sent();
    ...
    SapQueryRunner.prototype.createIndexSql = function (table, index) {
        ...
        return new Query("CREATE ".concat(indexType, "INDEX \"").concat(index.name, "\" ON ").concat(this.escapePath(table), " (").concat(columns, ") ").concat(index.where ? "WHERE " + index.where : ""));
    };
    /**
    ...
    SapQueryRunner.prototype.dropIndexSql = function (table, indexOrName) {
        ...
        if (!parsedTableName.schema) {
            ...
            return new Query("DROP INDEX \"".concat(parsedTableName.schema, "\".\"").concat(indexName, "\""));
        }
    };
    /**
    ...
    SapQueryRunner.prototype.dropForeignKeySql = function (tableOrName, foreignKeyOrName) {
        ...
        return new Query("ALTER TABLE ".concat(this.escapePath(tableOrName), " DROP CONSTRAINT \"").concat(foreignKeyName, "\""));
    };
    /**
