...
var OracleQueryRunner = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.query("SELECT 1 AS \"exists\" FROM global_name@\"".concat(database, "\""))];
                    case 1:
                        query = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.query("CREATE DATABASE IF NOT EXISTS \"".concat(database, "\";"))];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        newTable.name = dbName ? "".concat(dbName, ".").concat(newTableName) : newTableName;
                        // rename table
                        ...
                        newTable.indices.forEach(function (index) {
                            ...
                            // build queries
                            upQueries.push(new Query("ALTER INDEX \"".concat(index.name, "\" RENAME TO \"").concat(newIndexName, "\"")));
                            downQueries.push(new Query("ALTER INDEX \"".concat(newIndexName, "\" RENAME TO \"").concat(index.name, "\"")));
                            // replace constraint name
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        upQueries = [];
                        downQueries = [];
                        upQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " ADD ").concat(this.buildCreateColumnSql(column))));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (!oldColumn)
                            throw new TypeORMError("Column \"".concat(oldTableColumnOrName, "\" was not found in the ").concat(this.escapePath(table), " table."));
                        newColumn = undefined;
                ...
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        if (this.isColumnChanged(oldColumn, newColumn, true)) {
                            ...
                            upQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " MODIFY \"").concat(oldColumn.name, "\" ").concat(this.connection.driver.createFullType(newColumn), " ").concat(defaultUp, " ").concat(nullableUp)));
                            downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " MODIFY \"").concat(oldColumn.name, "\" ").concat(this.connection.driver.createFullType(oldColumn), " ").concat(defaultDown, " ").concat(nullableDown)));
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (!column)
                            throw new TypeORMError("Column \"".concat(columnOrName, "\" was not found in table ").concat(this.escapePath(table)));
                        clonedTable = table.clone();
                        upQueries = [];
                        downQueries = [];
                        ...
                        downQueries.push(new Query("ALTER TABLE ".concat(this.escapePath(table), " ADD ").concat(this.buildCreateColumnSql(column))));
                        return [4 /*yield*/, this.executeQueries(upQueries, downQueries)];
                    case 4:
                        _b.sent();
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        query = "SELECT \"T\".* FROM ".concat(this.escapePath(this.getTypeormMetadataTableName()), " \"T\" ") +
                            ...
                            "WHERE \"T\".\"type\" IN ( '".concat(MetadataTableType.MATERIALIZED_VIEW, "', '").concat(MetadataTableType.VIEW, "' )");
    ...
    OracleQueryRunner.prototype.createViewSql = function (view) {
        ...
        if (typeof view.expression === "string") {
            return new Query("CREATE ".concat(materializedClause, "VIEW ").concat(this.escapePath(view), " AS ").concat(view.expression));
        }
        else {
            return new Query("CREATE ".concat(materializedClause, "VIEW ").concat(this.escapePath(view), " AS ").concat(view.expression(this.connection).getQuery()));
        }
    };
    ...
    OracleQueryRunner.prototype.createIndexSql = function (table, index) {
        ...
        return new Query("CREATE ".concat(index.isUnique ? "UNIQUE " : "", "INDEX \"").concat(index.name, "\" ON ").concat(this.escapePath(table), " (").concat(columns, ")"));
    };
    /**
