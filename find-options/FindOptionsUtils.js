...
<<<<<<< HEAD
                if (!metadata.hasColumnWithPropertyPath("".concat(select)))
                    throw new error_1.TypeORMError("".concat(select, " column was not found in the ").concat(metadata.name, " entity."));
        ...
        if (options.lock) {
            if (options.lock.mode === "optimistic") {
                ...
                var tableNames = options.lock.tables ? options.lock.tables.map(function (table) {
                    ...
                    if (!tableAlias) {
<<<<<<< HEAD
                        throw new error_1.TypeORMError("\"".concat(table, "\" is not part of this query"));
=======
...
>>>>>>> a3495c7 (INIT)
    ...
    FindOptionsUtils.joinEagerRelations = function (qb, alias, metadata) {
        ...
        metadata.eagerRelations.forEach(function (relation) {
            ...
            var addJoin = true;
            try {
                for (var _c = (0, tslib_1.__values)(qb.expressionMap.joinAttributes), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var join = _d.value;
...
>>>>>>> a3495c7 (INIT)
            ...
            var addSelect = true;
            try {
                for (var _e = (0, tslib_1.__values)(qb.expressionMap.selects), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var select = _f.value;
