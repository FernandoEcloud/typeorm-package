...
var EmbeddedMetadata = /** @class */ (function () {
    ...
    EmbeddedMetadata.prototype.buildPartialPrefix = function () {
        ...
        throw new error_1.TypeORMError("Invalid prefix option given for ".concat(this.entityMetadata.targetName, "#").concat(this.propertyName));
    };
    EmbeddedMetadata.prototype.buildPrefix = function (connection) {
        ...
        prefixes.push.apply(prefixes, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this.buildPartialPrefix()), false));
