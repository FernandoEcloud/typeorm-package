...
var SqljsDriver = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(SqljsDriver, _super);
    // -------------------------------------------------------------------------
    // Constructor
    // -------------------------------------------------------------------------
...
>>>>>>> a3495c7 (INIT)
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 4];
                    case 3: throw new error_1.TypeORMError("localforage is not defined - please import localforage.js into your site");
...
>>>>>>> a3495c7 (INIT)
                    ...
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 7: throw new error_1.TypeORMError("localforage is not defined - please import localforage.js into your site");
    ...
    SqljsDriver.prototype.loadDependencies = function () {
        if (PlatformTools_1.PlatformTools.type === "browser") {
            ...
            try {
                var sqlite = this.options.driver || PlatformTools_1.PlatformTools.load("sql.js");
                this.sqlite = sqlite;
            }
            catch (e) {
